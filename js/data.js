...
const COLS = {
  ...
  deals: "id,client_name,company_name,seller_id,stage_id,value,status,probability,origin,created_at,closed_at,is_recurring,updated_at,deleted_at,last_interaction_at,campaign",
...
// ---------------------------------------------------------------------------
const STORE_CACHE_KEY = "sgcmp:store:v6"; // v6: deals.campaign (origem dos leads no Marketing) // v3: guarda menos colunas (ver COLS)
